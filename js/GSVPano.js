...
GSVPANO.PanoLoader = function (parameters) {
	...
	this.composePanorama = function (panoId) {
		...
		this.setProgress(0);
		msg.appendChild(document.createTextNode(count + ': Loading panorama for zoom ' + _zoom + '...'));
		msg.appendChild(document.createElement('br'));
		count++;
		// if (count > 5) { msg.innerHTML = ""; count = 0 }
	...
	this.load = function (location, callback) {
		...
		msg.appendChild(document.createElement('p').appendChild(document.createTextNode(cnt + ': Load for ' + location )));
		msg.appendChild(document.createElement('br'));
		cnt++;
		//if (count > 5) { msg.innerHTML = ""; count = 0 }
